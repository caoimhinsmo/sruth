<?php
  ...
  try {
    ...
    $T_Lorg_le_Google                 = $T->h('Lorg le Google');
    ...
    $T_Sguir                          = $T->h('Sguir');
    $T_Gearr_abairt_an_dariribh       = $T->h('Gearr_abairt_an_dariribh');
    $T_Gearr                          = $T->h('Geàrr');
    $T_mirean			      = $T->h('mìrean');
    $T_mhir                           = $T->h('mhìr');
    $T_Dearbhaich_ceart_fios          = $T->h('Dearbhaich_ceart_fios');
    $T_Chan_urrainn_dhut_sguabadh_as  = $T->h('Chan_urrainn_dhut_sguabadh_as');
    $T_Gearr_aig                      = $T->h('Gearr_aig');
    $T_Gearr_aig_fios                 = $T->h('Gearr_aig_fios');
    $T_Deasaich                       = $T->h('Deasaich');
    $T_Deasaich_an_abairt             = $T->h('Deasaich an abairt');
    $T_Buidheann_ur                   = $T->h('Buidheann ùr');
    $T_Buidheann_ur_fios              = $T->h('Buidheann_ur_fios');
    $T_OsAbairtean                    = $T->h('Os-abairtean');
    $T_FoAbairtean                    = $T->h('Fo-abairtean');
